...
const SEGMENT_WHITELIST = new Set(['nova', 'novo', 'relatorio', 'relatorios', 'visualizar', 'download', 'excluir', 'mensal', 'fechar', 'gerar', 'taxas', 'gerar-vencimentos', 'alertas', 'logs', 'aprovacoes', 'tarefas', 'ocorrencias', 'orcamentos', 'entradas-pendentes', 'saidas-pendentes', 'orcamentos-pendentes', 'ocorrencias-pendentes-aprovacao']);
