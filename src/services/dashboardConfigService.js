...
const dashboardConfigService = {
  ...
  defaultWidgets: [
    ...
    { key: 'overdue_tasks', title: 'Tarefas Atrasadas', position: 8, visible: true },
    { key: 'open_occurrences', title: 'Ocorrências Abertas', position: 9, visible: true },
    { key: 'pending_budgets', title: 'Orçamentos Pendentes', position: 10, visible: true },
    { key: 'pending_entries', title: 'Entradas Pendentes', position: 11, visible: true },
    { key: 'completed_maintenances', title: 'Manutenções Concluídas', position: 12, visible: false },
    { key: 'pending_occurrences_approval', title: 'Ocorrências Aguardando Aprovação', position: 13, visible: false },
    { key: 'monthly_comparison', title: 'Comparação Mensal', position: 14, visible: true },
  ],
